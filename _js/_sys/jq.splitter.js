	...
	return this.each(function() {
		...
		function moveSplitter(np) {
			...
			paneB.css(opts.set, np+splitbar._adjust+"px")
				.css(opts.adjust, group._adjust-splitbar._adjust-paneB._padAdjust-np-opts.ieParentAdjust+"px");
		...
		//cssCache(paneA, "_borderFixed",  "border", opts.fixSide1+"Width", opts.fixSide2+"Width");
		//cssCache(paneB, "_borderAdjust", "border", opts.adjSide1+"Width", opts.adjSide2+"Width");
		//cssCache(paneB, "_borderFixed",  "border", opts.fixSide1+"Width", opts.fixSide2+"Width");
		...
		group.bind("resize", function(e,size){
			...
			paneA.css(opts.fixed, group._fixed-paneA._padFixed-opts.ieParentAdjust+"px");
			paneB.css(opts.fixed, group._fixed-paneB._padFixed-opts.ieParentAdjust+"px");
			splitbar.css(opts.fixed, group._fixed-opts.ieParentAdjust+"px");
